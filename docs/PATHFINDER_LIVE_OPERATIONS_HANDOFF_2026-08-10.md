...
- catalog refresh telemetry records only a hashed route scope, safe catalog ID, counts, outcome, duration, and cache table class; failure copy preserves the existing cache and never exposes provider/Dynamo messages.
