...
function fixture() {
  ...
  const cycle = () => createWrikeAssuranceCycle({ config: { enabled: true, customer_id: scope.customer_id, import_method_id: scope.import_method_id, sla_seconds: 3600, max_candidates: 10 }, ledger, sharedCapture: shared });
